(define (end a b c rest)
  (cond [(= b 2) (append (list 1 0 1) rest)]
...
(define (wodniw a b c d rest acc)
  (cond [(and (= b 1) (= c 1)) (wodniw 1 0 0 d rest acc)]
        ...
        [(null? rest) (end b c d (cons a acc))]
        [else (wodniw b c d (car rest) (cdr rest) (cons a acc))]))

(define (ecuder li)
  (define (start a b c d rest)
    (if (and (= a 1) (= b 1)) (wodniw 0 0 c d rest '(1))
        (wodniw a b c d rest '())))
  (cond [(null? li) '()]
        [(= (car li) 0) (ecuder (cdr li))]
        [(or (null? (cdr li))
             (null? (cddr li))
...
(define (window a b c rest acc)
  (cond [(and (= a 0) (= b -1) (= c 0)) (window 1 0 -1 rest acc)]
        ...
        [(and (null? rest) (= 0 (+ a b c))) (ecuder acc)]
